  ...
  const projets = [
    {
      ...
      descriptionComplete: "Ce projet ambitieux vise à transformer le quartier de l'Ariane en un modèle de développement durable. Il comprend la rénovation énergétique de 500 logements, la création de 3 nouveaux parcs urbains, l'installation de 200 panneaux solaires et la mise en place d'un système de récupération des eaux de pluie.",
      statut: "en_cours",
    ...
    },
    {
      ...
      budget: "1.5M€",
      avancement: 10,
      responsable: "Association Quartier Ariane",
      participants: 420,
